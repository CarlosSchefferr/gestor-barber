<x-guest-layout>
    ...
    <div class="mb-8">
        <p class="text-xs font-semibold uppercase tracking-[0.22em] text-barber-500">Nova senha</p>
        <h1 class="mt-3 text-3xl font-bold leading-tight text-zinc-900">Redefinir senha</h1>
        <p class="mt-2 text-sm text-zinc-600">Defina sua nova senha para continuar no painel.</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2" x-data="{ showPassword: false, showConfirmation: false }">
            <div>
                <label for="password" class="text-sm font-semibold text-zinc-700">Nova senha</label>
            ...
            <div>
                <label for="password_confirmation" class="text-sm font-semibold text-zinc-700">Confirmar nova senha</label>
                <div class="relative mt-2">
                    <input
