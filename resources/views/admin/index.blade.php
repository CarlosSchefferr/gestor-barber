                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-2">
                                    <x-icon-action href="{{ route('admin.show', $usuario) }}" title="Ver" color="bg-white">
                                    ...
                                    <x-icon-action href="{{ route('admin.edit', $usuario) }}" title="Editar" color="bg-white">
                                    ...
                                    @if($usuario->id !== auth()->id())
                                        <x-icon-action href="#" title="Remover" color="bg-white" onclick="confirmDelete({{ $usuario->id }})">
